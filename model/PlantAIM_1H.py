...
def main():    
    ...
    for epoch in range(num_epochs):
        ...
        if ((epoch+1) % 1 == 0):
            print("Saving Model")
            torch.save(model_sl.state_dict(), os.path.join(Save_model_path,'ViT+CNN_1H_{}e_{:.4f}-plantaim1H_model.pth'
                                                                    .format(epoch+1,accuracy_p)))
    
            print("Saving optimizer")
            torch.save(optimizer.state_dict(), os.path.join(Save_model_path,'ViT+CNN_1H_{}e_{:.4f}-plantaim1H_opt.pth'
                                                                        .format(epoch+1,accuracy_p)))
