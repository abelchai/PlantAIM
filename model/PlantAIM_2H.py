...
for epoch in range(num_epochs):
    ...
    if ((epoch+1) % 1 == 0):
        print("Saving Model")
        torch.save(model_sl.state_dict(), os.path.join(Save_model_path,'ViT+CNN_2H_{}e_{:.4f}_{:.4f}-model-S1-1.pth'
                                                                .format(epoch+1,accuracy_train_d,accuracy_d)))

        print("Saving optimizer")
        torch.save(optimizer.state_dict(), os.path.join(Save_model_path,'ViT+CNN_2H_{}e_{:.4f}_{:.4f}-opt-S1-1.pth'
                                                                    .format(epoch+1,accuracy_train_d,accuracy_d)))
